        ...
        <div className="flex-col justify-center items-center ml-[24px] mr-[24px] mt-[60px]">
            <div className="justify-center flex-col items-center text-center min-h-[200px] bg-card rounded-[30px] border border-stroke w-full xl:w-[1230px] mx-auto">
                ...
                <div className="flex justify-center items-center mb-8 mt-[25px]">
                    <div onClick={() => window.open("https://t.me/+w5rjdLcHyeI2NjMy", "_blank")} className="group flex items-center w-max pl-[20px] pr-[20px] h-[40px] rounded-[100px] border-[1px] border-white cursor-pointer transition-colors duration-400 hover:bg-green hover:border-green sm:pl-[30px] sm:pr-[30px] sm:h-[57px] sm:border-[1.50px]">
